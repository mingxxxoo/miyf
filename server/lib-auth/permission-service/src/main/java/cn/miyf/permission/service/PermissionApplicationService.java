...
import cn.miyf.permission.repository.mapper.SysMenuMapper;
...
public class PermissionApplicationService extends BaseApplicationService {
    ...
    public List<SysMenuTreeVo> currentUserMenus() {
        ...
        List<SysMenuTreeVo> roots = buildMenuTree(all);
     ...
     */
    public List<SysMenuTreeVo> listMenusTree() {
     ...
     * @history 1.00 2026-09-08 XieMingJie Created.
     */
    public List<SysPermissionTreeVo> listPermissionsTree() {
        ...
        return TreeUtils.builder(
                        SysPermissionTreeVo::getId,
                        SysPermissionTreeVo::getParentId,
                        SysPermissionTreeVo::getChildren,
                        SysPermissionTreeVo::setChildren)
                .rootWhen(pid -> pid == null)
                .sortBy(Comparator
                        .comparing(SysPermissionTreeVo::getSortOrder, Comparator.nullsLast(Integer::compareTo))
                        .thenComparing(SysPermissionTreeVo::getCode, Comparator.nullsLast(String::compareTo)))
                .buildMapped(all, this::toPermissionTreeVo);
    }
    ...
    private List<SysMenuTreeVo> buildMenuTree(List<SysMenuEntity> menus) {
        return TreeUtils.builder(
                        SysMenuTreeVo::getId,
                ...
                .rootWhen(pid -> pid == null)
                .sortBy(Comparator
                        .comparing(SysMenuTreeVo::getSortOrder, Comparator.nullsLast(Integer::compareTo))
                        .thenComparing(SysMenuTreeVo::getId, Comparator.nullsLast(Long::compareTo)))
                .buildMapped(menus, this::toMenuVo);
    }

    private SysPermissionTreeVo toPermissionTreeVo(SysPermissionEntity entity) {
        return new SysPermissionTreeVo()
                .setId(entity.getId())
                ...
                .setPermNo(entity.getPermNo())
                .setProduct(entity.getProduct())
                .setTreeName(entity.getTreeName())
    ...
    /**
     * 更新权限组；permissionIds 非 null 时重绑权限点。
     *
     * @param id  权限组 ID
     * @param dto 请求
     * @return 权限组 VO
    ...
    private void assertMenuParentNotCycle(Long menuId, Long parentId) {
        ...
        if (Objects.equals(menuId, parentId)) {
            throw new BusinessException(ErrorCode.BAD_REQUEST, "父级菜单不能指向自己");
        }
