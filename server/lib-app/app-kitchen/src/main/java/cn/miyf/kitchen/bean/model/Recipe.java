...
public class Recipe {
    ...
    public Integer getPrepareMinutes() { return prepareMinutes; }
    public void setPrepareMinutes(Integer prepareMinutes) { this.prepareMinutes = prepareMinutes; }
    ...
    public List<Map<String, Object>> getSeasonings() { return seasonings; }
    public void setSeasonings(List<Map<String, Object>> seasonings) { this.seasonings = seasonings; }
